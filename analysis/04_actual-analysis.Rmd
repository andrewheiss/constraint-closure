...
mega_means_plot <- function(df, var_name, xlab, title, add_to_right = 0, add_to_left = 0.03) {
...
ggsave(plot_fitness_boxplot, filename = here("analysis", "output", "fitness_A.tiff"),
       width = params$fig_width, height = params$fig_height, units = "in", type = "cairo", dpi = 600)
```
...
ggsave(combined_fitness, filename = here("analysis", "output", "fitness_boxplots.tiff"),
...
ggsave(plot_fitness_importance_ls, filename = here("analysis", "output", "fitness_B.png"),
       width = params$fig_width, height = params$fig_height, units = "in", type = "cairo", dpi = 300)
ggsave(plot_fitness_importance_ls, filename = here("analysis", "output", "fitness_B.tiff"),
       width = params$fig_width, height = params$fig_height, units = "in", type = "cairo", dpi = 600)
```
...
plot_fitness_all <- mega_means_plot(constraint_combo_outcomes_ls, landscape_fitness_linked, 
                                    ...
                                    title = "C: Average landscape fitness across combinations of constraints")
...
ggsave(plot_fitness_all, filename = here("analysis", "output", "fitness_means_all.tiff"),
       width = params$fig_width_big, height = params$fig_height_big, units = "in", type = "cairo", dpi = 600)
```
...
ggsave(plot_landscape_fitness_variance, filename = here("analysis", "output", "fitness_variance.png"),
       width = params$fig_width, height = params$fig_height, units = "in", type = "cairo", dpi = 300)
ggsave(plot_landscape_fitness_variance, filename = here("analysis", "output", "fitness_variance.tiff"),
       width = params$fig_width, height = params$fig_height, units = "in", type = "cairo", dpi = 600)
```


## Figure 6: Evological evenness
...
ggsave(plot_evenness_boxplot, filename = here("analysis", "output", "evenness_A.png"),
       width = params$fig_width, height = params$fig_height, units = "in", type = "cairo", dpi = 300)
ggsave(plot_evenness_boxplot, filename = here("analysis", "output", "evenness_A.tiff"),
       width = params$fig_width, height = params$fig_height, units = "in", type = "cairo", dpi = 600)
```
...
ggsave(plot_evenness_importance_ls, filename = here("analysis", "output", "evenness_B.png"),
       width = params$fig_width, height = params$fig_height, units = "in", type = "cairo", dpi = 300)
ggsave(plot_evenness_importance_ls, filename = here("analysis", "output", "evenness_B.tiff"),
       width = params$fig_width, height = params$fig_height, units = "in", type = "cairo", dpi = 600)
```
...
plot_evenness_all <- mega_means_plot(constraint_combo_outcomes_ls, avg_evenness_t, 
                                     ...
                                     title = "C: Average ecological evenness across combinations of constraints", 
                                     add_to_left = 0.08)
...
ggsave(plot_evenness_all, filename = here("analysis", "output", "evenness_means_all.png"),
       width = params$fig_width_big, height = params$fig_height_big, units = "in", type = "cairo", dpi = 300)
ggsave(plot_evenness_all, filename = here("analysis", "output", "evenness_means_all.tiff"),
       width = params$fig_width_big, height = params$fig_height_big, units = "in", type = "cairo", dpi = 600)
```
...
plot_richness_boxplot <- ggplot(sim_ls, aes(x = n_constraints_f, y = landscape_richness_mean)) +
  ...
  labs(x = "Number of constraints",
       ...
       subtitle = "Values near zero indicate high richness",
       caption = glue("<span style='color:{clrs$grey}'>◆</span> = mean value")) +
  theme_constraint() + 
  theme(panel.grid.major.x = element_blank(),
        plot.caption = element_markdown(),
...
ggsave(plot_richness_boxplot, filename = here("analysis", "output", "richness_A.png"),
       width = params$fig_width, height = params$fig_height, units = "in", type = "cairo", dpi = 300)
ggsave(plot_richness_boxplot, filename = here("analysis", "output", "richness_A.tiff"),
       width = params$fig_width, height = params$fig_height, units = "in", type = "cairo", dpi = 600)
```
...
ggsave(plot_richness_importance_ls, filename = here("analysis", "output", "richness_B.png"),
       width = params$fig_width, height = params$fig_height, units = "in", type = "cairo", dpi = 300)
ggsave(plot_richness_importance_ls, filename = here("analysis", "output", "richness_B.tiff"),
       width = params$fig_width, height = params$fig_height, units = "in", type = "cairo", dpi = 600)
```
...
plot_richness_all <- mega_means_plot(constraint_combo_outcomes_ls, landscape_richness_mean, 
                                     ...
                                     title = "C: Average landscape richness across combinations of constraints", 
                                     add_to_left = 1)
...
ggsave(plot_richness_all, filename = here("analysis", "output", "richness_means_all.png"),
       width = params$fig_width_big, height = params$fig_height_big, units = "in", type = "cairo", dpi = 300)
ggsave(plot_richness_all, filename = here("analysis", "output", "richness_means_all.tiff"),
       width = params$fig_width_big, height = params$fig_height_big, units = "in", type = "cairo", dpi = 600)
```
...
ggsave(plot_turnover_boxplot, filename = here("analysis", "output", "turnover_A.png"),
       width = params$fig_width, height = params$fig_height, units = "in", type = "cairo", dpi = 300)
ggsave(plot_turnover_boxplot, filename = here("analysis", "output", "turnover_A.tiff"),
       width = params$fig_width, height = params$fig_height, units = "in", type = "cairo", dpi = 600)
```
...
ggsave(plot_turnover_importance_ls, filename = here("analysis", "output", "turnover_B.png"),
       width = params$fig_width, height = params$fig_height, units = "in", type = "cairo", dpi = 300)
ggsave(plot_turnover_importance_ls, filename = here("analysis", "output", "turnover_B.tiff"),
       width = params$fig_width, height = params$fig_height, units = "in", type = "cairo", dpi = 600)
```
...
plot_turnover_all <- mega_means_plot(constraint_combo_outcomes_ls, turnover_diff, 
                                     ...
                                     title = "C: Average ∆ in turnover (linked species − unlinked species) across combinations of constraints", 
                                     add_to_right = 0.02, add_to_left = 0.02)
...
ggsave(plot_turnover_all, filename = here("analysis", "output", "turnover_means_all.png"),
       width = params$fig_width_big, height = params$fig_height_big, units = "in", type = "cairo", dpi = 300)
ggsave(plot_turnover_all, filename = here("analysis", "output", "turnover_means_all.tiff"),
       width = params$fig_width_big, height = params$fig_height_big, units = "in", type = "cairo", dpi = 600)
```
